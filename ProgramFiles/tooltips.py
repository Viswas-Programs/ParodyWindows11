...
THEME_BG="Yellow"
THEME_FG="Black"
def _createToolTipAtGivenPos(widget: tkinter.Widget, id: str, root: tkinter.Tk, message: str, command, event: tkinter.Event, **kwargs):
...
def createToolTipAtGivenPos(widget: tkinter.Widget, id: str, root: tkinter.Tk, message: str, command=None, **kwargs):
    ...
    widget.bind("<Enter>", lambda e: _createToolTipAtGivenPos(widget, id, root, message, command, e, **kwargs))
