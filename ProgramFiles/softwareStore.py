...
def showDescription(e=None):
    def uninstallProgram(e=None):
        try:
            with open("ProgramFiles/APPS_LIST.txt", "wr") as uninstallProgram:
            ...
            with open("ProgramFiles/APPS_COMMAND_LIST.txt", "wr") as uninstallProgramC:
    ...
    if item not in FTRConfigSettings("ProgramFiles/APPS_LIST.txt", None):
